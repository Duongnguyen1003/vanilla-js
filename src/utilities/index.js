...
// Navigo gồm:
// root string: là /
// linksSelector: mỗi 1 page đều phải render ra single page a, không bị reload page nữa
// hash: true khi call api không bị reload page
...
const render = (component, container) => { 
    //component: nội dung hiển thị
    // container: là vị trí mà chúng ta muốn hiển thị
